...
function fbdown(link) {
  return new Promise((resolve, reject) => {
    ...
    axios.post('https://www.getfvid.com/downloader', new URLSearchParams(Object.entries(config)), {
      headers: {
    ...
    .then(async ({ data }) => {
      ...
      resolve({
        video: {
          normal: $('body > div.page-content > div > div > div.col-lg-10.col-md-10.col-centered > div > div:nth-child(3) > div > div.col-md-4.btns-download > p:nth-child(1) > a').attr('href'),
